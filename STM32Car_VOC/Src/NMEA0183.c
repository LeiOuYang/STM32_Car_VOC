...
unsigned char init_nmea0183(NMEA0183* nmea)
{
	if((void*)0==nmea) return 0;
	
	nmea->gpsData.gps_yaw = 0;
	nmea->gpsData.ground_course = 0;
	nmea->gpsData.ground_speed = 0;
	nmea->gpsData.have_gps_yaw = 0;
	nmea->gpsData.hdop = 999;
	nmea->gpsData.instance = 0;
	nmea->gpsData.last_gps_time_ms = 0;
	nmea->gpsData.location.alt = 999.9;
	nmea->gpsData.num_sats = 0;
	nmea->gpsData.vdop = 0;
	nmea->gpsData.status = 0;
	nmea->gpsData.location.lat = 0.0;
	nmea->gpsData.location.lng = 0.0;
...
unsigned char is_good(NMEA0183* nmea)
{
	if((void*)0==nmea) return 0;
	
	return nmea->gpsParse.gps_data_good;
}

void set_good(NMEA0183* nmea, unsigned char good)
{
	if((void*)0==nmea) return;
	
	nmea->gpsParse.gps_data_good = good;
}
